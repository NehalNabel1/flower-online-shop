...
import fs from 'fs'
export const admin_addProducts_get = async(request :Request , response : Response) =>{
    try{
...
export const admin_addProducts_post= async(request :Request , response : Response) =>{
    try{
...
export const admin_manageOrders_get= async(request :Request , response : Response)=>{
        try{
...
export const admin_updateOrder_post= async(request :Request , response : Response)=>{
    try{
...
export const admin_deleteOrder_post = async(request :Request  ,response :Response)=>{
    try{
...
export const admin_deleteProducts_post= async(request :Request , response : Response) =>{
    try{       
