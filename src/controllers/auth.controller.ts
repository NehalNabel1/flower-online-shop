...
export const auth_login_post = async(request :Request , response : Response)=>{
    try{
...
export const auth_signup_post = async(request :Request , response : Response)=>{
    try{
...
export const auth_signup_get = (request :Request , response : Response)=>{
    const authError = request.flash('authError');
...
export const auth_logout_all= (request :Request , response : Response)=>{
